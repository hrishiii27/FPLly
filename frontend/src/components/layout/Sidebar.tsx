import { NAV_GROUPS, type TabId } from '../../lib/nav'
...
export default function Sidebar({ activeTab, setActiveTab, open, onClose }: Props) {
  return (
    <>
      ...
      <aside
        className={`md:hidden fixed top-0 bottom-0 left-0 z-50 w-60 overflow-y-auto border-r border-border/60 glass-aside transition-transform duration-200 ${
          open ? 'translate-x-0' : '-translate-x-full'
        }`}
      >
        <nav className="py-4 px-3" aria-label="Primary">
